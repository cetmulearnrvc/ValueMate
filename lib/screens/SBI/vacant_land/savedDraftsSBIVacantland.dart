...
class _SavedDraftsSBIVacantLandState extends State<SavedDraftsSBIVacantLand> {
  ...
  Future<void> searchByDate() async {
    ...
    try {
      ...
      // print("Fetching SBI Vacant Land from: $url3");
      ...
      final response = await http.post(
        ...
        body: json.encode({
          'date': formattedDate,
          'type': 'sbiVacantLand' // Specific filter for SBI Vacant Land
        }),
      );
                                  ...
                                  ? Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Icon(
                                              Icons
                                                  .landscape_outlined, // Land Icon
                                              size: 50,
                                              color: Colors.blueGrey.shade200),
                                          const SizedBox(height: 12),
                                          Text(
                                            'No vacant land drafts found',
                                            style: TextStyle(
                                              fontSize: 16,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Container(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(
                                              // Robust Ref ID check
                                              'Ref ID: ${property['refId'] ?? property['refNo'] ?? 'N/A'}',
                                              style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 16,
                                            ...
                                            subtitle: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  _buildInfoRow(
                                                      Icons.location_on,
                                                      'Location: ${property['addressAsPerActual'] ?? property['addressActual'] ?? property['addressDocument'] ?? 'N/A'}'),
                                                  const SizedBox(height: 4),
                                                  _buildInfoRow(
                                                      Icons.event_available,
                                                      'Inspection: ${property['dateOfInspection'] ?? 'N/A'}'),
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          const SizedBox(
                                                              width: 6),
                                                          Text(
                                                            'Value: ₹${property['presentMarketValue'] ?? property['totalAbstractLand']}',
                                                            style:
                                                                const TextStyle(
                                                              fontSize: 14,
                                                              fontWeight:
