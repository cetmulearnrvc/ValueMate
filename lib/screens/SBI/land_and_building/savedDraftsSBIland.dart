...
class SavedDraftsSBILand extends StatefulWidget {
  ...
  @override
  State<SavedDraftsSBILand> createState() => _SavedDraftsSBILandState();
}

class _SavedDraftsSBILandState extends State<SavedDraftsSBILand> {
  ...
  Future<void> searchByDate() async {
    ...
    try {
      ...
      // print("Fetching SBI Land drafts from: $url3");
  ...
  void navigateToValuationForm(Map<String, dynamic> propertyData) {
    Navigator.push(
      context,
      MaterialPageRoute(
        // Corrected navigation for Land & Building
        builder: (context) => SBIValuationFormPage(
                                  ...
                                  ? Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Icon(
                                              Icons
                                                  .domain_outlined, // Land/Building Icon
                                              size: 50,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  _buildInfoRow(Icons.person,
                                                      'Owner: ${property['nameOfOwner'] ?? property['ownerName'] ?? 'N/A'}'),
                                                  const SizedBox(height: 4),
                                                  _buildInfoRow(
                                                      Icons.location_on,
