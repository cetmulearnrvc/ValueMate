        ...
        return pw.Column(
          ...
          children: [
            ...
            _buildSectionTable([
              ...
              _buildTableRow('5.', 'Name of the applicant(s)', data.nameOfApplicant),
          ...
          children: [
            ...
            _buildSectionTableWithHeader(
              ...
              rows: [
                ...
                // --- Apartment Building Table Rows (same as SIB but with SBI data) ---
            ...
            pw.Text('Details of Valuation:', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
               pw.Table(
                  ...
                  children: [
                    ...
                    pw.TableRow(children: [
                       _dataCell(''), _dataCell('Total', bold: true), _dataCell(''), _dataCell(''), _dataCell('')
                    ])
                  ]
               ),
               pw.SizedBox(height: 20),
