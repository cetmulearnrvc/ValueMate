...
class _SavedDraftsState extends State<SavedDrafts> {
  ...
  Future<void> searchByDate() async {
    ...
    try {
      ...
      // print("Fetching SBI Flat drafts from: $url3"); // Debug print
                                  ...
                                  ? Center(
                                      child: Column(
                                        ...
                                        children: [
                                          Icon(
                                              Icons
                                                  .apartment_outlined, // Apartment icon for Flats
                                              size: 50,
                                              color: Colors.blueGrey.shade200),
                                          const SizedBox(height: 12),
                                          Text(
                                            'No SBI Flat drafts found',
                                            style: TextStyle(
                                              fontSize: 16,
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Container(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(
                                              // Using refNo based on previous SIB patterns, adjust if API differs
