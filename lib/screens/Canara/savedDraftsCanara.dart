...
class _SavedDraftsCanaraState extends State<SavedDraftsCanara> {
  ...
  Future<void> searchByDate() async {
    ...
    try {
      ...
      // debugPrint("send req to back: $url3");
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return Container(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(
                                              'Ref.No: ${property['referenceNo'] ?? 'N/A'}',
                                              style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 16,
                                            ...
                                            subtitle: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  _buildInfoRow(
                                                      Icons.location_on,
                                                      'Location: ${property['propertyAddress'] ?? 'N/A'}'),
                                                  const SizedBox(height: 4),
                                                  _buildInfoRow(Icons.event,
                                                      'Report: ${property['Date'] ?? 'N/A'} | Insp: ${property['createdAt'] != null ? DateFormat('dd-MM-yyyy').format(DateTime.parse(property['createdAt']).toLocal()) : 'N/A'}'),
                                                ],
                                              ),
                                            ),
                                            trailing: Container(
