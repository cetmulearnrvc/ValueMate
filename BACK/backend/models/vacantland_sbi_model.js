...
// Main schema for SBI Vacant Land Valuation
const vacantLandValuationSBISchema = new mongoose.Schema({
  // Reference ID
  refNo: String,
  ...
  bankName: {
    type: String,
    default: 'State Bank of India' // Default set to SBI
  },
  branchName: String,
...
vacantLandValuationSBISchema.pre('save', function(next) {
  this.updatedAt = new Date();
  next();
});

const VacantLandValuationSBI = mongoose.model('VacantLandValuationSBI', vacantLandValuationSBISchema);

export default VacantLandValuationSBI;